...
export default function PatientLayout({ children }: PatientLayoutProps) {
  ...
  const navigation = [
    ...
    { name: "Medical Certificates", href: "/patient/medical-certificate", icon: Stethoscope },
    { name: "Payment History", href: "/patient/payments", icon: CreditCard },
    { name: "Chat Support", href: "/patient/chat", icon: MessageSquare },
        ...
        <div className="fixed inset-y-0 left-0 flex w-full max-w-xs flex-col bg-white shadow-xl">
          <div className="flex h-16 items-center justify-between px-4 border-b border-emerald-200">
            <div className="flex items-center space-x-3">
              ...
              <span className="text-lg font-bold text-emerald-800">MEGH</span>
            </div>
          ...
          <div className="p-4 border-t border-emerald-200 bg-emerald-50">
            <div className="flex items-center space-x-3 mb-4 p-3 bg-white rounded-lg shadow-sm">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-sm font-medium text-emerald-800">John Doe</p>
          ...
          <div className="flex flex-1 gap-x-4 self-stretch lg:gap-x-6">
            <div className="flex items-center gap-x-4 lg:gap-x-6">
              ...
              <div className="flex items-center space-x-2">
                ...
                <span className="text-sm text-emerald-700 font-medium">Account Active</span>
              </div>
            </div>
